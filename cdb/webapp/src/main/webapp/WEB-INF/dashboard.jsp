...
<body>
    ...
    <footer class="navbar-fixed-bottom">
        <div class="container text-center">
            <ul class="pagination">
                <li> <c:if test="${page.currentPage > 1}"> 
                    <a href="/web-app/dashboard?page=${page.currentPage-1}${searchValue}${colonneValue}${ascendingValue}${nbByPageValue}" aria-label="Previous">
                      <span aria-hidden="true">&laquo;</span>
                  </a>
                  </c:if>
              </li>
              <li> 
              <a href="dashboard?page=${page.currentPage}${searchValue}${colonneValue}${ascendingValue}${nbByPageValue}">${page.currentPage}</a></li>
              <li><a href="dashboard?page=${page.currentPage+1}${searchValue}${colonneValue}${ascendingValue}${nbByPageValue}">${page.currentPage+1}</a></li>
              <li><a href="dashboard?page=${page.currentPage+2}${searchValue}${colonneValue}${ascendingValue}${nbByPageValue}">${page.currentPage+2}</a></li>
              <li><a href="dashboard?page=${page.currentPage+3}${searchValue}${colonneValue}${ascendingValue}${nbByPageValue}">${page.currentPage+3}</a></li>
              <li><a href="dashboard?page=${page.currentPage+4}${searchValue}${colonneValue}${ascendingValue}${nbByPageValue}">${page.currentPage+4}</a></li>
              <li> <c:if test="${page.currentPage < control_page }">
                <a href="dashboard?page=${page.currentPage+1}${searchValue}${colonneValue}${ascendingValue}${nbByPageValue}" aria-label="Next">
        ...
        <div class="btn-group btn-group-sm pull-right" role="group" >
            ...
            <a href="dashboard?nbByPage=10${searchValue}${colonneValue}${ascendingValue}"><button type="button" class="btn btn-default ${active}">10</button></a>
            <c:set var="active" value=""/>
            <c:if test = "${nbByPage == 50}">
               <c:set var="active" value="active"/>
            </c:if>
            <a href="dashboard?nbByPage=50${searchValue}${colonneValue}${ascendingValue}"><button type="button" class="btn btn-default ${active}">50</button></a>
            <c:set var="active" value=""/>
            <c:if test = "${nbByPage == 100}">
               <c:set var="active" value="active"/>
            </c:if>
            <a href="dashboard?nbByPage=100${searchValue}${colonneValue}${ascendingValue}"><button type="button" class="btn btn-default ${active}">100</button></a>
        	</div>
